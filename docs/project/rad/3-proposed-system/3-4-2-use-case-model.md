...
| Sezione                  | Contenuto                                                                                                                                                                                                                                                                                                                                   |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Eccezioni**            | **No connection:** The system warns the user and prevents the login from starting. • **Incorrect credentials or cancellation:** The Identity Provider returns an error; the system returns the user to the initial login screen with an error message. • **Identity Provider unreachable:** The system advises the user to try again later. |
...
|                          |                                                                                                                                                                                                                                                                                                   |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Eccezioni**            | **Booking failed:** If the prerequisites are not met or the external academic system rejects the request, the system displays a message explaining the rejection. • **No exams available:** The system displays a blank state with the message **"No exams currently open for your study plan"**. |
